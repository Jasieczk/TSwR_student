...
class Poly3(TrajectoryGenerator):
    ...
    def generate(self, t):
        ...
        q_dot = (3*self.a_3 - 3*self.a_2 + 3*self.a_1 - 3*self.a_0) * t**2 + (2*self.a_2 - 4*self.a_1 + 6*self.a_0)*t + self.a_1 - 3*self.a_0
        q_ddot = (6*self.a_3 - 6*self.a_2 + 6*self.a_1 - 6*self.a_0) * t + 2*self.a_2 - 4*self.a_1 + 6*self.a_0
